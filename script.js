/*
const p = document.getElementById('titre');
const elements = document.getElementsByClassName('info');
const attribut = document.getElementsByName('email');
const span = document.getElementById('contenu').getElementsByTagName('span');
const ele = document.querySelectorAll('div#contenu');
*/
